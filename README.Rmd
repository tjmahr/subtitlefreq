...
(*)The `allve` tokens are spurious corrections that are undone later on but I
need to prevent them from being created.)
...
contractions I have missed. We would get around 1K contractions with some 
patching.
